              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="alert alert-danger">
                    La reserva en línea de tu nuevo apartamento <b>{{ $apartment->number }}</b> no pudo ser procesada
                  </div>
                </div>
                <div class="card-footer justify-content-end pt-3 pb-0 d-flex align-items-center">
                  <a href="#" class="btn btn-success d-inline-flex align-items-center mb-0">
                    Volver a intentar
                    <span class="arrow-right-white ml-3"></span>
                  </a>
                </div>
              </div>
            </div>
